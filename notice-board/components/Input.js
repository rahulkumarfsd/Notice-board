export default function Input({ label, error, className = "", id, ...props }) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        id={id}
        className={`w-full rounded-lg border bg-ink-50 px-3.5 py-2.5 text-sm text-ink-800 placeholder:text-ink-500 transition-colors focus:outline-none focus:ring-2 ${
          error
